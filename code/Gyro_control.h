...
#ifndef CODE_GYRO_CONTROL_H_
#define CODE_GYRO_CONTROL_H_
...
#define GYRO_TRANSITION_FACTOR   (16.4f)                 // 陀螺仪数据转换系数（LSB/(°/s)）
...
typedef struct
{
    ...
    pid_cycle_struct           turn_cycle;              // 速度环控制器
